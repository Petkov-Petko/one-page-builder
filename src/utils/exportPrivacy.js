export function exportPrivacy1(email, url, country) {
...
export function exportPrivacy2(email, url, country) {
    return `<?php include 'functions.php';
$title = 'Privacy policy page';
$description = 'This Privacy Policy describes the information that we gather on or through our Services and how we use and process such information.';
echo site_header($title, $description);
...
<div class="container py-3">
    ...
    <p>Welcome to  test name.</p>
    <p>test name (“us”, “we”, or “our”) operates ${url || 'domain.com'} (hereinafter referred to as “Service”).</p>
    <p>Our Privacy Policy governs your visit to ${url || 'domain.com'}, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
    ...
    <p>2. Definitions</p>
    <p>SERVICE means the website operated by test name.</p>
    ...
    <p>5. Use of Data</p>
    <p>test name uses the collected data for various purposes:</p>
    ...
    <p>If you are located outside ${country || 'United Kingdom'} and choose to provide information to us, please note that we transfer the data, including Personal Data, to  ${country || 'United Kingdom'} and process it there.</p>
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
    <p>test name will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    ...
    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at ${email || 'info(@)domain.com'}.</p>
    ...
    <p>0.4. users are able to change their personal information by emailing us at ${email || 'info(@)domain.com'}.</p>
